			...
			<tr>
				<td>
					<div align="left">
						<p><br />
						<br />
						<span class="commentstyle">Perfect Match (on provided fields).</span></p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
					</div>
				</td>
				...
				<div align="left">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td colspan="<?php echo $this->countFields + 1;?>"><a href="<?php echo $this->url(array(), 'default:show-partial-match') . '?' . $this->query;?>">Show partial records</a></td>
						</tr>
						<tr>
							<td height="27" class="style5">&nbsp;</td>
